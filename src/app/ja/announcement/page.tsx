...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: a.metaTitle,
    description: a.metaDescription,
    url: `${siteConfig.url}/ja/announcement`,
  ...
  alternates: {
    canonical: `${siteConfig.url}/ja/announcement`,
    languages: {
...
export default function JapaneseAnnouncementPage() {
  return <AnnouncementContent locale="ja" />;
}
