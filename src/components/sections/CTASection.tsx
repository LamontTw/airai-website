...
export default function CTASection({ locale = 'zh' }: { locale?: Locale }) {
  const t = getTranslations(locale);

  return (
    <section className="section-padding bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 relative overflow-hidden">
      {/* Background Pattern */}
      ...
      <div className="container-max relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <ScrollReveal delay={400} className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20">
        ...
        {/* Urgency Note */}
        <ScrollReveal delay={1000} className="text-center mt-12">
